...
class AdminAgeGroupMapperTest {
    ...
    fun `toResponseDto should map all fields from entity`() {
        ...
        assertThat(responseDto)
            .extracting("id", "groupName", "minAge", "maxAge", "active")
            .containsExactly(id, "Adults", 18, 64, true)
    }
    ...
    fun `toEntity with NewRequestDTO should map all fields correctly`() {
        ...
        assertThat(entity)
            .extracting("id", "groupName", "minAge", "maxAge", "active")
            .containsExactly(id, "Toddlers", 1, 2, true)
    }
    ...
    fun `toEntity with UpdateRequestDTO should map all fields correctly`() {
        ...
        assertThat(entity)
            .extracting("id", "groupName", "minAge", "maxAge", "active")
            .containsExactly(id, "Infants", 0, 1, false)
    }
}